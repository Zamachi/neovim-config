...
--vim.opt.showtabline = 2 -- prikazuje tabove
vim.opt.undofile = true
vim.opt.numberwidth = 4 -- sirina number kolone u gutteru
vim.opt.signcolumn = "yes" -- da li se uvek prikazuje signcolumn u gutteru
